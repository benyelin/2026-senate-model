...
def main():
    ...
    run([py, "build_senate_candidate_war_audit.py"])
    run([py, "build_senate_candidate_quality_framework_audit.py"])
    run([py, "apply_senate_candidate_quality_framework.py", "--apply"])
    run([py, "finalize_senate_candidate_framework_fundamentals.py"])
    ...
    run([py, "apply_senate_polling_confidence_accelerator.py"])
    run([py, "finalize_senate_bayesian_confidence_aliases.py"])
